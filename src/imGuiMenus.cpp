...
bool global_variables_open = false;
bool assign_global_key = false;
unsigned int assign_global_key_index = -1;

char buff[30];

float MainMenuBarOffset = 19.0f;
// Component Selector Settings
const ImVec2 ComponentSelectorBasePos = { 0.0f, MainMenuBarOffset };
const ImVec2 ComponentSelectorBaseSize = { 232.0f, 484.0f };
// File Browser Settings
const ImVec2 FileBrowserBasePos = { 0.0f, 484.0f };
const ImVec2 FileBrowserBaseSize = { 232.0f, 236.0f };
// Game Scene Viewer Settings
const ImVec2 GameSceneViewerBasePos = { 231.0f, MainMenuBarOffset };
const ImVec2 GameSceneViewerBaseSize = { 566.0f, 484.0f };
// Asset Viewer Settings
const ImVec2 AssetViewerBasePos = { 231.0f, 484.0f };
const ImVec2 AssetViewerBaseSize = { 566.0f, 236.0f };
// Object Viewer Settings
const ImVec2 ObjectViewerBasePos = { 797.0f, MainMenuBarOffset };
const ImVec2 ObjectViewerBaseSize = { 287.0f, 720.0f };
